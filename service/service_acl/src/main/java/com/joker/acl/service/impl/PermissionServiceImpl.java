...
import com.joker.acl.entity.Permission;
import com.joker.acl.entity.RolePermission;
import com.joker.acl.entity.User;
import com.joker.acl.helper.MemuHelper;
import com.joker.acl.helper.PermissionHelper;
import com.joker.acl.mapper.PermissionMapper;
import com.joker.acl.service.PermissionService;
...
//        });
    ...
    @Override
    public List<Permission> getAllMenuGuli() {
    ...
    private List<Permission> buildPermission(List<Permission> permissions) {
        ...
        permissions.stream().forEach(permissionNode -> {
                if("0".equals(permissionNode.getPid())){
                    permissionNode.setLevel(1);
